export default {
  ...
  scope: 'global',
  params: {
    r:       { type: 'float', min: 0, max: 1, step: 0.005, default: 0.90, label: 'Paper R' },
    g:       { type: 'float', min: 0, max: 1, step: 0.005, default: 0.92, label: 'Paper G' },
    b:       { type: 'float', min: 0, max: 1, step: 0.005, default: 0.94, label: 'Paper B' },
...
void main(){
  ...
  vec3 paper = vec3(p_r, p_g, p_b) + grain + fiber;
